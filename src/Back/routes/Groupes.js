...
app.get('/note',function(req,res,next){ 
     ...
     async.parallel([
        ...
        //      var xyz = "";
        //      var mabcParseStringifyParse ="";
        //      var uiop="";
        //      var tab= [];
        // for (r1 in groupe)
        //   {  
        //       var groupeTabNote = new Array();
        ...
        //                     b = JSON.stringify(projet[r2]).substring(1,JSON.stringify(projet[r2]).length-1);
        //                     c.push(jalon_projet[r3]);
        //                   }
        //               }
                    
        //             c = JSON.stringify(c);

        //             max = JSON.stringify(nbJPmax) + ",";
        //             var mabc = "[" + max + "[" +a + b +"}], " + c +"]";
                    
        //             mabcParse = JSON.parse(mabc);
        //                      //console.log("---------------- mabcParse ----------")
        //                      //console.log(mabcParse);

        //             tab.(mabcParse);

        //             // mabcParseStringifyParse += JSON.stringify(mabcParse) + ", ";
        //             //         console.log("---------------- mabcParseStringifyParse ----------")
        //             //         console.log(mabcParseStringifyParse);
        ...
        //   console.log(tab);
        //     // mabcParseStringifyParse = mabcParseStringifyParse.substring(0, mabcParseStringifyParse.length-2);
        //     //xyz = mabcParseStringifyParse;
